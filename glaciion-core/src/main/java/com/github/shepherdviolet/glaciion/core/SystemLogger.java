...
class SystemLogger implements SpiLogger {
    ...
    private static final String GLACIION = " com.github.shepherdviolet.glaciion ";
    ...
    SystemLogger() {
        ...
        timeFormat = System.getProperty(VMOPT_SYSTEM_LOGTIME, "yyyy-MM-dd HH:mm:ss.SSS");
    ...
    public void trace(String msg, Throwable t) {
        if (logLevel >= TRACE) {
            System.out.println(getTimeString() + GLACIION + msg);
            if (t != null) {
                t.printStackTrace();
            }
        }
