...
public class PreLoader {
     ...
     * NOTICE: Preloading automatically in the Spring environment or set -Dglaciion.conf.preload.auto=true.
     */
    ...
    private static void preload0(ClassLoader classLoader, String classloaderId){
        ...
        if (interfaces.size() <= 0 && LOGGER.isInfoEnabled()) {
            LOGGER.info("? | Preload | No definition found in " + PATH_INTERFACES + " files", null);
        }
